...
def draw():
    ...
    for i in range(0, 3):
        pyxel.rectb(19, 24+(i*5), 15, 7, 10+i)
        pyxel.rectb(34, 24+(i*5), 15, 7, 10+i)
        pyxel.rectb(49, 24+(i*5), 15, 7, 10+i)
        pyxel.rectb(64, 24+(i*5), 15, 7, 10+i)
        pyxel.rectb(79, 24+(i*5), 15, 7, 10+i)
        pyxel.rectb(94, 24+(i*5), 15, 7, 10+i)
